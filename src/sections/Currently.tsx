...
export function Currently() {
  ...
  return (
    <section className="px-[var(--gutter)] py-[var(--rhythm-sm)]">
      <Rule className="mb-8" />
      <div className="grid grid-cols-4 gap-x-[var(--gutter)] gap-y-6 md:grid-cols-12">
        <div className="col-span-4 md:col-span-3">
          <Kicker label="Currently" />
        </div>
        <Reveal className="col-span-4 md:col-span-8 md:col-start-4">
          <p className="text-balance font-sans text-xl leading-[1.15] tracking-tight text-ink">
            Building PreFlight — a review companion for Apple developers.
          </p>
        </Reveal>
      </div>
