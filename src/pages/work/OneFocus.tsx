...
export function OneFocus() {
  const project = work.find((item) => item.slug === 'onefocus')!
    ...
    <div className="pb-[var(--rhythm)]">
      ...
      <div className="mt-16 px-[var(--gutter)]">
        <Reveal y={40}>
          <div className="relative aspect-[16/10] w-full overflow-hidden border border-line bg-paper md:aspect-[16/8]">
            <img
              src="/images/onefocus/icon.png"
              alt="OneFocus app icon."
          ...
          <p className="mt-3 font-mono text-xs tracking-[0.04em] text-mute uppercase">
            OneFocus on iPhone and Mac — tasks, focus sessions, notes, and clipboard in one place.
          </p>
        </Reveal>
      </div>
      ...
      <div className="mt-16 px-[var(--gutter)] md:mt-24">
        ...
        <div className="grid grid-cols-4 gap-x-[var(--gutter)] gap-y-10 md:grid-cols-12">
          <Kicker label="Core Features" className="col-span-4 md:col-span-3" />
